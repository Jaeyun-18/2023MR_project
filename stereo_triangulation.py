...
def calibrate_camera(images_folder):
    ...
    columns = COLUMNS  # number of checkerboard columns.
...
def triangulate(mtx1, mtx2, R, T):
    ...
    # this call will cause a crash if you use cv.imshow() above. Comment out cv.imshow() to see this.
    plt.show()
    ...
    connections = [[0, 1], [1, 2], [2, 3], [3, 4], [1, 5], [5, 6], [
        6, 7], [1, 8], [1, 9], [2, 8], [5, 9], [8, 9], [0, 10], [0, 11]]
    for _c in connections:
        print(p3ds[_c[0]])
        print(p3ds[_c[1]])
        ax.plot(xs=[p3ds[_c[0], 0], p3ds[_c[1], 0]], ys=[
                p3ds[_c[0], 1], p3ds[_c[1], 1]], zs=[p3ds[_c[0], 2], p3ds[_c[1], 2]], c='red')
...
mtx1, dist1 = calibrate_camera(images_folder='cali_imgs/left_imgs/*')
print(mtx1, dist1)


mtx2, dist2 = calibrate_camera(images_folder='cali_imgs/right_imgs/*')
print(mtx2, dist2)

R, T = stereo_calibrate(mtx1, dist1, mtx2, dist2, 'cali_imgs/sync_imgs/*')
print(R, T)
